...
export default function Header( { auth , userName } ) {
  const [name, setName] = useState()

  const handleLogout = () => {
    localStorage.removeItem('isAuthId')
    window.location.reload()
  }

  useEffect(()=>{
    if(userName.data !== null && localStorage.getItem('isAuthId') !== null ) {
      setName(userName.data[+localStorage.getItem('isAuthId')].username);
    }
